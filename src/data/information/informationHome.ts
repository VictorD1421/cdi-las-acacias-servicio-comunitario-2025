// data/informationHome.ts
const informationHome = {
  title: "CDI Dr. José María Vargas",
  subtitle: "Parroquia Joaquin Crepo",
  paragraphs: [
    {
      text: "El centro de diagnóstico integral (CDI) Dr. Jose maría Vargas fue creado como parte de la misión barrio adentro, una iniciativa del gobierno bolivariano para garantizar el acceso gratuito a la salud en comunidades populares, su creación se enmarca dentro del auge de los CDI en la década de los 2000, impulsado por la cooperación médico-cubana y el ministerio del poder popular para la salud.",
    },
    {
      text: "El centro lleva el nombre del ilustre médico venezolano José María Vargas símbolo de la medicina humanista científica en el país.",
    },
    {
    ...
    {
      text: "Nuestra misión es brindar atención médica integral, gratuita y de calidad a toda la población venezolana, sin distinción alguna, con énfasis en la atención primaria y la prevención de enfermedades, buscando mejorar la salud de la comunidad.",
    },
  ],
  images: [
    "home1.jpg",
